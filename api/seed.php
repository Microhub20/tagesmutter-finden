...
$demo = [
  ['sabine-k','Sabine K.','Albstadt',2,'Mo–Fr 7:00–15:00',['0–1 Jahr','1–3 Jahre'],1,
  ...
  ['melanie-r','Melanie R.','Hechingen',1,'Mo–Do 7:30–16:30',['1–3 Jahre'],1,
  ...
  ['fatma-oe','Fatma Ö.','Balingen',0,'Mo–Fr 7:00–17:00',['0–1 Jahr','1–3 Jahre'],1,
  ...
  ['claudia-b','Claudia B.','Meßstetten',3,'Flexibel, auch Randzeiten & Sa',['1–3 Jahre','3+ Jahre'],1,
  ...
  ['jennifer-m','Jennifer M.','Bisingen',1,'Mo–Fr 8:00–14:00',['1–3 Jahre'],1,
...
$ins = $pdo->prepare(
    "INSERT INTO tagesmuetter
     (id,name,ort,bundesland,plaetze,zeiten,altersgruppen,persoenlich,email,tel,erlaubnis,foto,status)
     VALUES (?,?,?,'Baden-Württemberg',?,?,?,?,?,?,?,NULL,'approved')"
);
foreach ($demo as $d) {
    $del->execute([$d[0]]);
