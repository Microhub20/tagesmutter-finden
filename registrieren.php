...
<title>Als Tagesmutter registrieren – Tagesmutter finden in Balingen</title>
...
<div class="demo-banner">🚧 Vorschau-Version — das Portal ist noch im Aufbau</div>
...
<div class="reg-wrap">
  <div class="reg-card">
    ...
    <form id="form" novalidate>
      ...
      <div class="field">
        <label for="in-foto">Foto <span class="opt">(optional)</span></label>
        <div class="photo-upload">
          <div class="photo-preview" id="foto-preview">📷</div>
          <div class="photo-meta">
            <input type="file" id="in-foto" accept="image/*">
            <p class="opt-hint">Erscheint auf deinem Profil. Ohne Foto zeigt dein Profil einen Platzhalter.</p>
            <a href="#" id="foto-entfernen" hidden>✕ Foto entfernen</a>
          </div>
        </div>
      </div>
      <div class="field">
...
<script>
// Stadtteile ins Dropdown
const inOrt = document.getElementById("in-ort");
STADTTEILE.forEach(s => inOrt.insertAdjacentHTML("beforeend", `<option>${s}</option>`));
